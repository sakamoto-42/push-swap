...
/*   Updated: 2025/01/06 11:52:44 by juduchar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_check_is_int(int ac, char **av)
{
	ft_atoi()
}
...
{
	if (ft_check_is_nbr(ac, av) && ft_check_is_int(ac, av) && ft_check_is_unique(ac, av))
		return (0);
	return (1);
